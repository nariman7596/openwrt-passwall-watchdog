...
If the proxy tunnel keeps failing after repeated restarts (e.g. all nodes are down),
the watchdog stops retrying and stands by — no restart storms, no CPU waste.
...
| `PROXY_RESTART_LIMIT` | Max restart attempts before standing by (default: 3) |
